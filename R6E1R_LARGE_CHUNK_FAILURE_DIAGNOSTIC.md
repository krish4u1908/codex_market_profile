...
Status: **ROOT CAUSE CONFIRMED; REPAIR INCLUDED IN V2; CURRENT V2 RERUN PENDING**
...
- Runtime flush/finalization: `src/banknifty_profiler/shadow/orchestrator.py:1448-1485` and `1495-1544`.
- Immutable publication and append-once identity: `src/banknifty_profiler/shadow/orchestrator.py:2727-2772` and `2988-3028`.

## Post-diagnostic retained-detail resolution

A later bounded retained-snapshot run identified the complete ledger delta:
one provisional absence-based lifecycle expiration,
`R6B2R-F91B70D4B8E10376C90C`, and its linked cross-layer transition,
`XL-0BC3579C663866CBE2C768A1`. There were no clean-only rows and no
shared-identity content mismatches. Later standalone Index evidence removed the
expiration from final chronology, proving a real ghost-publication defect in
addition to the harness-accounting defect.

The v2 repair defers that provisional lifecycle row, participation transitions
for its episode, and cross-layer rows sourced from either surface until the
condition clears or the session seals. The harness now uses exact per-session
refresh targets, opportunity-aware closure accounting, and bounded row-free
failure summaries. Restart-before-response and restart-before-seal regressions
pass. Fresh v2 focused and six-session all-nine runs remain mandatory.
...
- Configuration SHA-256 at tested commit: `5ce1058763ecc47494f9bdf231439117c6a4fb64c2e491d70395b4be0c50b031`
- Engine SHA-256 at tested commit: `021935bc0722b16a16e3af52deb7a7f26ef1aa6b4983aa3442420596bc00725d`
- Engine-manifest SHA-256 at tested commit: `715a82b48e7bffe68f749f94c29b6d0e098bfe0e55f24d91e00db690e38827b3`
