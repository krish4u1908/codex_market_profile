"""Compact, auditable BankNifty weighted-cash and India-VIX context samples.
...
independent display context used by the BankNifty V2 GUI:
...
SAMPLE_SCHEMA = "BANKNIFTY_CASH_VIX_SAMPLE_V2"
MANIFEST_SCHEMA = "BANKNIFTY_CASH_VIX_MANIFEST_V2"
...
PARAMETER_CONTRACT = {
    "cash_weighted_pct": {
        "unit": "PERCENT",
        "weighting": "COLLECTOR_STARTUP_BANKNIFTY_WEIGHTS_NORMALIZED_TO_AVAILABLE_WEIGHT",
