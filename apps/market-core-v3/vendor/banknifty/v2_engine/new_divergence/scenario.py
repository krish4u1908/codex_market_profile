        ...
        if (
            ...
            return _result(
                ...
                [
                    ...
                    f"BankNifty Futures volume reached {float(futures_climaxes[-1]['ratio']):.6g}x its eligible baseline.",
                ],
                ...
                metrics, ["BANKNIFTY_FUTURES_VOLUME_CLIMAX", "OBSERVED_LONG_BUILDUP", "FUTURES_LONG_LIQUIDATION", "FAILED_CE_CONTROL", "BASIS_CONTRACTION"],
