...
## GUI 3.0.7: near-OTM OI entry bubbles
...
spikes and can seek replay. VPOC is for manual review only and does not filter
either direction. See [the rule and replay walkthrough](OI_ENTRY_REPLAY.md)
